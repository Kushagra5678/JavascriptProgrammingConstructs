...
console.log("Max :" + Math.max(firstNumber,secondNumber,thirdNumber,fourthNumber,fifthNumber));
console.log("Min :" + Math.min(firstNumber,secondNumber,thirdNumber,fourthNumber,fifthNumber));